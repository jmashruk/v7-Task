...
def create_dataloader(path, imgsz, batch_size, stride, opt, transformation_path = None, hyp=None, augment=False, cache=False, pad=0.0, rect=False,
...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
                 cache_images=False, single_cls=False, transformation_path = None, stride=32, pad=0.0, prefix=''):
        self.img_size = img_size
    ...
    def __getitem__(self, index):
        ...
        def save_image(img, step, index):
            cv2.imwrite(f'{self.transformation_path}/image_{index}_transformed_step_{step}.jpg', img[:, :, ::-1])  # Save image
        ...
        if mosaic:
            ...
            save_step += 1
            save_image(img, save_step, index)
...
# ... rest of your class or other code ...
    @staticmethod
